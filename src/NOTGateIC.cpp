...
void NOTGateIC<T> :: simulate() {
    if ((this -> powerConnected) && (this -> groundConnected)) {
        ...
        this -> pins[9 - 1] = !this -> pins[8 - 1];   // Gate 4 (Pin 8 and Pin 9)
        this -> pins[11 - 1] = !this -> pins[10 - 1]; // Gate 5 (Pin 10 and Pin 11)
        this -> pins[13 - 1] = !this -> pins[12 - 1]; // Gate 6 (Pin 12 and Pin 13)
    } else
